...
function ReservationTable({ isCheckStatus }) {
  ...
  const { columns, rows, expired_debt, ExpiryDateDialogComponent, SnackbarComponent, isLoading } =
    useReservationData(isCheckStatus);
